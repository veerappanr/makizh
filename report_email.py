...
if __name__ == "__main__":
    user = os.getenv('USER')
    description_directory = '/home/student-02-e130edcab998/supplier-data/descriptions/'.format(user)  # The directory which contains all the files with data in it.
    current_date = datetime.date.today().strftime("%B %d, %Y")  # Creating data in format "March 20, 2022"
    ...
    msg = generate_email("automation@example.com", "student-02-e130edcab998@example.com".format(user),
